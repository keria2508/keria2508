                ...
                case "1": {
                    ...
                    switch (type) {
                        case "a": {
                            ...
                            Document book = new Book(id, name, number, author, numberPage);
                        ...
                        case "b": {
                            ...
                            Document newspaper = new Newspaper(id, name, number, dayIssue);
                        ...
                        case "c": {
                            ...
                            int numberIssue = scanner.nextInt();
                            System.out.print("Enter issue month : ");
                            int monthIssue = scanner.nextInt();
                            Document journal = new Journal(id, name, number, numberIssue, monthIssue);
